...
public class DBTest {
	...
	public static void main(String[] args) {
		...
		List<Location> com = (List<Location>) u1.getLocations();
		for(Location locat : com) {
			System.out.println(locat.getName());
		}
...
//				
		...
		List<Event> events = eventdao.getInvitedEvents(1);
		for(Event ev : events) {
			System.out.println(ev.getId() + " " + ev.getDescription());
		}
